...
form.addEventListener("submit", function (e) {
  ...
  // localStorage.setItem("anna_mess-value1", messvalue1);

  // Which Dish
  const dishvalue1 = dishname1.value;
  localStorage.setItem("anna_dish-value1", dishvalue1);

  const dishvalue2 = dishname2.value;
  localStorage.setItem("anna_dish-value2", dishvalue2);

  // Price
  const pricevalue1 = price1.value;
  localStorage.setItem("anna_price-value1", pricevalue1);

  const pricevalue2 = price2.value;
  localStorage.setItem("anna_price-value2", pricevalue2);


  // Number of Chapati's
  const chapativalue1 = chapati1.value;
  localStorage.setItem("anna_chapati-value1",chapativalue1);

  const chapativalue2 = chapati2.value;
  localStorage.setItem("anna_chapati-value2",chapativalue2);


  // Dal and Rice
  const dalvalue1 = dal1.value;
  localStorage.setItem("anna_dal-value1",dalvalue1);
